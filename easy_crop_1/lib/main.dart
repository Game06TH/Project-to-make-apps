      ...
      body: loading
        ...
        child: Column(
          children: [
            ...
            // ---- ปุ่ม gradient น้ำเงิน สั้น กลางจอ และโชว์เฉพาะเวลาทำงาน ----
            if (studentsWithImage.isNotEmpty)
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 14),
                child: Center(
                  child: SizedBox(
                    width: MediaQuery.of(context).size.width * 0.8, // responsive, หรือ fix เป็น 380
                    height: 48,
                    child: InkWell(
